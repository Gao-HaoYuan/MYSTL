...
void string_test()
{
  ...
  GHYSTL::string str;
  GHYSTL::string str1(5, 'a');
  GHYSTL::string str2(str1, 3);
  GHYSTL::string str3(str1, 0, 3);
  GHYSTL::string str4("abc");
  GHYSTL::string str5("abcde",3);
  GHYSTL::string str6(s, s + 5);
  GHYSTL::string str7(str1);
  GHYSTL::string str8(std::move(str1));
  GHYSTL::string str9;
  str9 = str2;
  GHYSTL::string str10;
  str10 = std::move(str2);
